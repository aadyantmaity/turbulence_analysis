...
detailed_offshore_dir_svg = os.path.join(output_dir_svg, "turbulence_detailed_offshore")
...
offshore_3year_dir_svg = os.path.join(output_dir_svg, "offshore_3year")
...
offshore_full_dir_svg = os.path.join(output_dir_svg, "offshore_full")
...
detailed_offshore_dir_png = os.path.join(output_dir_png, "turbulence_detailed_offshore")
...
offshore_3year_dir_png = os.path.join(output_dir_png, "offshore_3year")
...
offshore_full_dir_png = os.path.join(output_dir_png, "offshore_full")
