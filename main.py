...
detailed_general_dir_svg = os.path.join(
    output_dir_svg_general, "turbulence_detailed_general")
detailed_burbank_dir_svg = os.path.join(
    output_dir_svg_burbank, "turbulence_detailed_burbank")
detailed_offshore_dir_svg = os.path.join(
    output_dir_svg_santaana, "turbulence_detailed_offshore")
...
offshore_3year_dir_svg = os.path.join(
    output_dir_svg_santaana, "offshore_3year")
...
detailed_general_dir_png = os.path.join(
    output_dir_png_general, "turbulence_detailed_general")
detailed_burbank_dir_png = os.path.join(
    output_dir_png_burbank, "turbulence_detailed_burbank")
detailed_offshore_dir_png = os.path.join(
    output_dir_png_santaana, "turbulence_detailed_offshore")
...
offshore_3year_dir_png = os.path.join(
    output_dir_png_santaana, "offshore_3year")
...
if __name__ == "__main__":
    ...
    from spatialturbulence import plot_turbulence_for_jan6_to_jan9_google_maps, plot_turbulence_for_dec30_to_jan5_google_maps

    # svg plots

    # PLOT TURBULENCE DETAILED
    plot_detailed_turbulence_general(
        df, "Detailed Turbulence Reports", detailed_general_dir_svg, True)
    plot_detailed_turbulence_burbank(
        burbank_turbulence, "Detailed Turbulence Reports - Burbank (BUR)", detailed_burbank_dir_svg, True)
    plot_detailed_turbulence_general(
        offshore_flow, "Detailed Turbulence Reports - Offshore Flow", detailed_offshore_dir_svg, True)

    # PLOT TURBULENCE 3 YEAR CHUNKS
    plot_turbulence_by_3year_chunks(
        df, "Turbulence Reports", general_3year_dir_svg, False, True)
    plot_turbulence_by_3year_chunks(
        burbank_turbulence, "Turbulence Reports - Burbank (BUR)", burbank_3year_dir_svg, True, True)
    plot_turbulence_by_3year_chunks(
        offshore_flow, "Turbulence Reports - Offshore Flow", offshore_3year_dir_svg, False, True)

    # PLOT TURBULENCE FULL Range
    plot_turbulence_full_range(
        df, "Turbulence Reports", general_full_dir_svg, False, True)
    plot_turbulence_full_range(
        burbank_turbulence, "Turbulence Reports - Burbank (BUR)", burbank_full_dir_svg, True, True)
    plot_turbulence_full_range(
        offshore_flow, "Turbulence Reports - Offshore Flow", offshore_full_dir_svg, True, True)

    # PLOT TURBULENCE FOR DEC 30 to JAN 9
    plot_turbulence_for_jan6_to_jan9_google_maps(
        df, "Turbulence Reports", output_dir_svg_spatial_terrain)
    plot_turbulence_for_dec30_to_jan5_google_maps(
        df, "Turbulence Reports", output_dir_svg_spatial_terrain)
    ...
    # PLOT TURBULENCE DETAILED
    plot_detailed_turbulence_general(
        df, "Detailed Turbulence Reports", detailed_general_dir_png, False)
    plot_detailed_turbulence_burbank(
        burbank_turbulence, "Detailed Turbulence Reports - Burbank (BUR)", detailed_burbank_dir_png, False)
    plot_detailed_turbulence_general(
        offshore_flow, "Detailed Turbulence Reports - Offshore Flow", detailed_offshore_dir_png, False)

    # PLOT TURBULENCE 3 YEAR CHUNKS
    plot_turbulence_by_3year_chunks(
        df, "Turbulence Reports", general_3year_dir_png, False, False)
    plot_turbulence_by_3year_chunks(
        burbank_turbulence, "Turbulence Reports - Burbank (BUR)", burbank_3year_dir_png, True, False)
    plot_turbulence_by_3year_chunks(
        offshore_flow, "Turbulence Reports - Offshore Flow", offshore_3year_dir_png, False, False)

    # PLOT TURBULENCE FULL Range
    plot_turbulence_full_range(
        df, "Turbulence Reports", general_full_dir_png, False, False)
    plot_turbulence_full_range(
        burbank_turbulence, "Turbulence Reports - Burbank (BUR)", burbank_full_dir_png, True, False)
    plot_turbulence_full_range(
        offshore_flow, "Turbulence Reports - Offshore Flow", offshore_full_dir_png, True, False)
